...
# Use zqsd to move. 'a' to go up and 'e' to go down
...
func _move():
	...
	input_vector.x = Input.get_action_strength("ui_right_d") - Input.get_action_strength("ui_left_q")
	input_vector.z = Input.get_action_strength("ui_down_s") - Input.get_action_strength("ui_up_z")
